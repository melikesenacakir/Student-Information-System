    ...
    <div class="container-fluid">
        ...
        <div class="container vh-100 d-flex justify-content-center align-items-center">
            ...
            <div class="row">
                ...
                <div class='row g-3'>
                    <div class='form-floating mb-3 col-md-6'>
                        <input type='text' class='form-control form-control-lg bg-gradient' name='ad' placeholder='Ad' value='{$_GET['ad']}'>
                        <label for='text'>Ad</label>
                    </div>
                    <div class='form-floating mb-3 col-md-6'>
                        <input type='text' class='form-control form-control-lg bg-gradient' name='soyad' placeholder='Soyad' value='{$_GET['soyad']}'>
                        <label for='text'>Soyad</label>
                    </div>
                    <div class='form-floating mb-3 col-md-6'>
                        <input type='text' class='form-control form-control-lg bg-gradient' name='kadi' placeholder='Kullanıcı Adınız' value='{$_GET['kullaniciadi']}'>
                        <label for='text'>Kullanıcı Adı</label>
                    </div>
                    <div class='form-floating mb-3 col-md-6'>
                        <input type='password' class='form-control form-control-lg bg-gradient' id='password' name='sifre' placeholder='Şifreniz' value='{$_GET['sifre']}'>
                        <label for='Password'>Şifre</label>
                    </div>
                    <div class='d-grid gap-3 form-floating'>
                    <input type='submit' class='btn btn-outline-success form-control-lg' name='buton' value='kaydet'>
                            ...
                            if (isset($_POST['ad'])) {
                                ...
                                $sonuc = $db->prepare($sql);
                                $hash = password_hash($sifre, PASSWORD_ARGON2ID);
                                $sonuc->execute([$ad, $soyad, $kadi, $hash,$_GET['ad'],$_GET['soyad'],$_GET['kullaniciadi'],$_GET['sifre']]);
                                echo "<script>Swal.fire({
