    ...
    <div class="row">
        <div class="p-5 rounded-5 bg-gradient">
            <form action="#" method="post">
                <h3 class=" text-center text-light mt-3">SORUMLU ÖĞRETMEN</h3>
                ...
                <a href="login.php" class="text-decoration-none text-black">Öğrenci Giriş Sistemi</a>
                </div>
            </form>
            <?php
            if($_POST){
